...
object C {
    ...
    const val UI_REMOVE_GAMES = "ui_remove_games"
    const val UI_REMOVE_POPULAR = "ui_remove_popular"
    const val UI_REMOVE_FOLLOWING = "ui_remove_following"
    const val UI_REMOVE_SAVED = "ui_remove_saved"
