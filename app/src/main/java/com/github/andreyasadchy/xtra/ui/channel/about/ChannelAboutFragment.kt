...
@AndroidEntryPoint
class ChannelAboutFragment : PagedListFragment(), Scrollable {

    private var _binding: CommonRecyclerViewLayoutBinding? = null
    private val binding get() = _binding!!
    private val viewModel: ChannelAboutViewModel by viewModels()
    private lateinit var pagingAdapter: PagingDataAdapter<ChannelPanel, out RecyclerView.ViewHolder>
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        pagingAdapter = ChannelPanelAdapter(this)
